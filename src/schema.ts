...
export const parseQueryParams = (query: any) => {
  return {
    ...
    minNumberSeats: query.minNumberSeats
      ? parseInt(query.minNumberSeats, 10)
      : undefined,
    ...
    minFreeKilometer: query.minFreeKilometer
      ? parseInt(query.minFreeKilometer, 10)
      : undefined,
  };
};
